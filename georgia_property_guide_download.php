<?php
/**
 * Georgia Property Guide Download Webhook Implementation
 * 
 * Captures data, stores it in georgia_property_guide_download.json,
...
// 2. Local Logging (Store in georgia_property_guide_download.json)
$logEntry = json_encode([
    'timestamp' => date('Y-m-d H:i:s'),
    'data' => $data ?: $rawData
]) . PHP_EOL;

file_put_contents(__DIR__ . '/georgia_property_guide_download.json', $logEntry, FILE_APPEND);
...
$name = $formFields['name']['value'] ?? 'Georgia Property Guide Lead';
...
$bitrixFields = [
    'fields' => [
        'TITLE' => 'Georgia Property Guide Download: ' . $name,
        'NAME' => $name,
        'SOURCE_ID' => 'CALLBACK',            // "Zamprime Website"
        'ASSIGNED_BY_ID' => 1,                // Default ID (RE/MAX ZAM)
        'UF_CRM_1773862147183' => '21082',    // Subsource: "Georgia Property Guide Download"
...
file_put_contents(__DIR__ . '/georgia_property_guide_download_forward_log.txt', $logStatus . PHP_EOL, FILE_APPEND);
